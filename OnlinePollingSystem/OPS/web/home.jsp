...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="election2.jpg" alt="New York" width="1200" height="600">
      ...
      <div class="item">
        <img src="election3.jpg" alt="Chicago" width="1200" height="600">
        <div class="carousel-caption">
      ...
      <div class="item">
        <img src="election4.jpg" alt="Los Angeles" width="1200" height="600">
        <div class="carousel-caption">
...
<div id="contact" class="container">
  ...
  <div class="row">
    <div class="col-md-4">
      <p>Contact</p>
      <p><span class="glyphicon glyphicon-map-marker"></span> KIIT University</p>
      <p><span class="glyphicon glyphicon-phone"></span>Phone: +91 8013452823</p>
      <p><span class="glyphicon glyphicon-envelope"></span>Email: a.kr.dey98@gmail.com</p>	   
    </div>
      <form method="POST" action="commandposting">
    <div class="col-md-8">
      <div class="row">
...
<footer class="text-center">
  ...
  <p>Created By Ayon & Saurav & Shejuti </p> 
