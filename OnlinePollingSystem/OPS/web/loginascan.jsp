...
<center>  
        <div class="top">
            <h1 id="title" class="hidden"><span id="logo">CandidateLogin</span></h1>
	</div>
        <br><br><br>
        <div class="animated fadeInUp">
            <pre>
            <form action="loggedincan.jsp" method="POST">
 ...
 Enter Login Id <input type="text" name="cid" placeholder="Enter Login Id " required=""/><br>
