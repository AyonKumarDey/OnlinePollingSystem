...
<%
    ...
    Criteria c=s.createCriteria(table.Email.class);
    List<table.Email>data=c.list();
%>
<br><br><br>
    <div style="margin-top:-300px;">
<center><h4>Total Queries=<%=data.size()%> </h4></center>

<table  class="gridalter" align="center" style="border-collapse:collapse;">
    <tr>
        <th> ID</th>
        <th> NAME</th>
        <th>E-mail </th>
